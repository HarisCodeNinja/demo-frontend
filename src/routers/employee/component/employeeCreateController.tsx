...
const EmployeeCreateDrawer: React.FC = () => {
  ...
  return (
  <Controls title={`Create ${EMPLOYEE_CONSTANTS.ENTITY_NAME}`} open={showForm} onClose={handleCloseDrawer} form={form} onSubmit={handleSubmit} type="drawer" width={600} loading={addEmployeeMutation.isPending}>
    <FormProvider {...form}>
      <EmployeeForm />
    </FormProvider>
  </Controls>

...
const RoleCompetencyCreateDrawer: React.FC = () => {
  ...
  return (
  <Controls title={`Create ${ROLECOMPETENCY_CONSTANTS.ENTITY_NAME}`} open={showForm} onClose={handleCloseDrawer} form={form} onSubmit={handleSubmit} type="drawer" width={600} loading={addRoleCompetencyMutation.isPending}>
    <FormProvider {...form}>
      <RoleCompetencyForm />
    </FormProvider>
  </Controls>

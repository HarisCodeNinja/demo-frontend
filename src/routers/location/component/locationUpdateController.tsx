...
const LocationUpdateDrawer: React.FC = () => {
  ...
  return (
    <Controls title={`Edit ${LOCATION_CONSTANTS.ENTITY_NAME}`} open={showEdit} onClose={handleCloseDrawer} form={form} onSubmit={updateData} type="drawer" width={600} loading={isLoading}>
  <FormProvider {...form}>
    <LocationUpdateForm />
  </FormProvider>
</Controls>

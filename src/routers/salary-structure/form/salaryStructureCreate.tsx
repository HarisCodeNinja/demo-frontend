...
const SalaryStructureForm: React.FC<SalaryStructureFormProps> = ({}) => {
  const form = useFormContext<z.infer<typeof createSalaryStructurePayloadValidator>>();
        ...
        <FormField
          ...
          render={({ field: fieldProps }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea placeholder="Enter Allowances" {...fieldProps} value={fieldProps.value?.toString() || ''} className="resize-none font-mono" rows={6} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field: fieldProps }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea placeholder="Enter Deductions" {...fieldProps} value={fieldProps.value?.toString() || ''} className="resize-none font-mono" rows={6} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}

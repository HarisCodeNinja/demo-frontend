...
const LearningPlanCreateDrawer: React.FC = () => {
  ...
  return (
  <Controls title={`Create ${LEARNINGPLAN_CONSTANTS.ENTITY_NAME}`} open={showForm} onClose={handleCloseDrawer} form={form} onSubmit={handleSubmit} type="drawer" width={600} loading={addLearningPlanMutation.isPending}>
    <FormProvider {...form}>
      <LearningPlanForm />
    </FormProvider>
  </Controls>

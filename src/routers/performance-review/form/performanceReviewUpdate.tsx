...
const PerformanceReviewForm: React.FC<PerformanceReviewFormProps> = ({}) => {
  const form = useFormContext<z.infer<typeof updatePerformanceReviewPayloadValidator>>();
        ...
        <FormField
          ...
          render={({ field: fieldProps }) => (
            <FormItem>
              ...
              <FormControl>
                <Input type="text" placeholder="Enter Review Period" {...fieldProps} value={fieldProps.value?.toString() || ''} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field: fieldProps }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea placeholder="Enter Self Assessment" className="resize-none" {...fieldProps} value={fieldProps.value?.toString() || ''} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field: fieldProps }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea placeholder="Enter Manager Feedback" className="resize-none" {...fieldProps} value={fieldProps.value?.toString() || ''} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field: fieldProps }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea placeholder="Enter Recommendations" className="resize-none" {...fieldProps} value={fieldProps.value?.toString() || ''} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}

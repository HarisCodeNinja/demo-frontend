...
const CandidateSkillCreateDrawer: React.FC = () => {
  ...
  return (
  <Controls title={`Create ${CANDIDATESKILL_CONSTANTS.ENTITY_NAME}`} open={showForm} onClose={handleCloseDrawer} form={form} onSubmit={handleSubmit} type="drawer" width={600} loading={addCandidateSkillMutation.isPending}>
    <FormProvider {...form}>
      <CandidateSkillForm />
    </FormProvider>
  </Controls>

...
const JobOpeningSkillUpdateDrawer: React.FC = () => {
  ...
  return (
    <Controls title={`Edit ${JOBOPENINGSKILL_CONSTANTS.ENTITY_NAME}`} open={showEdit} onClose={handleCloseDrawer} form={form} onSubmit={updateData} type="drawer" width={600} loading={isLoading}>
  <FormProvider {...form}>
